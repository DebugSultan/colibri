...
/* The merged engine can drive either tier. This test is upstream's, so it
 * pins Q38_TIER_TRUNK=1 below; our qwen38_tier.c comes along only so that
 * the q38t_* symbols the engine now references link -- in trunk mode none
 * of them ever runs, and its statics were renamed off this TU's names. */
