...
- **0.3** **curva hit-rate contro `cap`**: 16 · 32 · 64 · 96 · 128 · **192**.
  ...
  **GRADINI 16/32/64 CHIUSI** (08/09, vedi §9); 96/128/192 in attesa di una
  finestra col K12 a riposo (cap 192 ≈ 54 GiB di processo non stanno in
  60 GB insieme al K12). ⚠️ **correzione**: `ColiExpertStoreStats` è la
